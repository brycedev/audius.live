defmodule AudiusLiveWeb.Presence do
  @moduledoc """
  ...
  alias AudiusLiveWeb.Presence.BadgeComponent
  ...
  def subscribe() do
    Phoenix.PubSub.subscribe(@pubsub, "hottopic")
  end
...
defmodule AudiusLiveWeb.Presence.BadgeComponent do
  use AudiusLiveWeb, :live_component
