defmodule AudiusLiveWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AudiusLiveWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AudiusLiveWeb.Gettext, "errors", msg, opts)
    end
  end
